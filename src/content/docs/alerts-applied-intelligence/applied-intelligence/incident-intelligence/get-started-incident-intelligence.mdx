...
<CollapserGroup>
  ...
  >
    ...
    2. On the left under **Correlate**, click **Sources** and then click **Alerts**.
    3. Select **Continue** on the "Get data from New Relic Alerts" page
    4. Select the policies you want to connect to Applied Intelligence, and click **Connect**.
  ...
  >
    By integrating Incident Intelligence with your Algorithmia machine-learning models, you can monitor your machine learning model performance. To configure Algorithmia for Incident Intelligence, see our [integration docs](/docs/integrations/mlops-integrations/algorithmia-mlops-integration/). 
  ...
  By integrating Incident Intelligence with your Superwise machine-learning models, you can monitor your machine learning model performance. To configure our Superwise integration, see our [docs](/docs/integrations/mlops-integrations/superwise-mlops-integration/).
